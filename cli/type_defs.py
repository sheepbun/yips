...
from typing import Any, ContextManager, Literal, TypedDict, Protocol, TYPE_CHECKING, Union
...
class YipsAgentProtocol(Protocol):
    ...
    resize_pending: bool
    pending_external_activity_refresh: bool
    ...
    def modal_prompt_application(self, app: Any) -> ContextManager[None]: ...
    ...
    def render_compact_title_bar(self) -> None: ...
